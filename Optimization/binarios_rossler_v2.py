...
def run_simulation(aa, bb, cc, output_file):
    ...
    x, y, z = 1, 1, 1  # condiciones iniciales
...
def main():
    ...
    params_df = pd.read_csv(
        '/home/xerk/Escritorio/Códigos para artículo/Artículo PSO ED GW/top_3_gwo_rossler.txt', sep=" ", header=None)
    ...
    for idx, params in enumerate(params_list):
        output_file = f'rossler_bin_{idx+1}.rnd'
