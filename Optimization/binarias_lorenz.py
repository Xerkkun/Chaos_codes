...
def euler_forward(X, h, sigma, rho, beta):
    """Método de Euler hacia adelante"""
    dX = lorenz_equations(X, sigma, rho, beta)
    X = X + h * np.array(dX)
    return X
# ===============================================================================
...
nn, ss, v, b, nstp = input('Parámetros de entrada: ').split()
...
print('Parámetros de diseño: ', sigma, rho, beta)

# "wb" para escribir archivos con formato binario
arch = open(b + "_" + "_lorenz_original_euler.rnd", "wb")
r, i = -1, -1
...
while r < s:
    ...
    x, y, z = euler_forward([xn, yn, zn], t_step, sigma, rho, beta)
    # print(x, y, z)
