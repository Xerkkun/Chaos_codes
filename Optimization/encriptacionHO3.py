...
nn,ss,tt,met,v,b,nstp,pos_pro = color*ancho*alto,1,5000,'AB6','x','mod255',1,'xor_shift'
...
hh = (0.001,0.01,0.001,0.001,0.001,0.0005) #Ancho de paso para cada método
r,i = -1,-1
binp = ''
pos_bin = ''
...
cv2.imwrite(imagen + ' ' + pos_pro + '.png',xor1)
rec1 = cv2.bitwise_xor(xor1, encryp2)
cv2.imwrite(imagen + ' ' + 'rec ' + pos_pro + '.png',rec1)
