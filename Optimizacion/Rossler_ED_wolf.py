...
#     # Encuentra los picos
   ...
   # Calcular el valor más alto que alcanzan los picos
    if peaksx.size > 0:
        ...
        max_peak_value_x = None  # O cualquier valor que consideres apropiado como indicador de un caso no válido o especial.
...
# Condición para descartar evoluciones temporales periódicas
    ...
    # print("Dimension Kaplan-Yorke", DKY)
...
f = open("progress_de_rossler.txt", 'w')
original = sys.stdout
...
output_file = "last_gen_de_rossler.dat"
np.savetxt(output_file, salida, delimiter="  ")

#[0.29808188 0.49703455 3.69246304]