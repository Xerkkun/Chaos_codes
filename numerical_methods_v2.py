...
def grunwald_letnikov(x, h_alpha, k, alpha, x_t, nu, d, mm, sigma, rho, beta, outputfile):
...
def runge_kutta4(x, x_t, k, h, sigma, rho, beta, d, outputfile):
...
#EN PROCESO
def caputo_derivative(x, x_t, k, h, sigma, rho, beta, d, outputfile):
